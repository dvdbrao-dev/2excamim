use crate::{
    ...
    events::{EventEnvelope, Linkage, OrderRegistered, OrderRegisteredPayload, Provenance},
};
...
impl RegisterOrderCommand {
    pub fn execute(&self) -> Result<EventEnvelope<OrderRegistered>, CommandError> {
        let payload: OrderRegisteredPayload = OrderRegistered {
